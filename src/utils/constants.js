...
export const API = Object.freeze({
  ...
  LAYERS: Object.freeze({
    // Feature Layers (spatial)
    ENVIRONMENTAL_ASSETS_LINE: 1,
    PERMITS: 2,
    ENVIRONMENTAL_ASSETS_POINT: 3,
    MONITORING_STATIONS: 4,
    ENVIRONMENTAL_ASSETS_POLYGON: 5,
    INSPECTION_LOCATIONS: 6,
    // Tables (non-spatial)
    ALERTS: 7,
    AUDIT_LOG: 8,
    COMPLETION_EVIDENCE: 9,
    // 10 is missing in service
    TRIGGERS: 11,
    CONTACTS: 12,
    DOCUMENTS: 13,
    DRIVER_AMENDMENTS: 14,
    DRIVER_POCS: 15,
    DRIVERS: 16,
    // 17 is missing in service
    MANAGEMENT_OF_CHANGE: 18,
    MONITORING_DATA: 19,
    OBLIGATIONS: 20,
    OBLIGATIONS_TO_TASKS: 21,
    OBLIGATION_TASK_JUNCTION: 22,
    CONDITIONS: 23,
    PERMIT_CONTACT_JUNCTION: 24,
    PERMIT_DOCUMENTS: 25,
    PERMITS_TO_CONTACTS: 26,
    PROJECT_ACCESS: 27,
    PROJECTS: 28,
    SPATIAL_LINKS: 29,
    STAKEHOLDER_COMPLAINTS: 30,
    STAKEHOLDERS: 31,
    TASKS: 32,
    TRAINING_HISTORY: 33,
    TRAINING_REQUIREMENTS: 34,
    TRANSMITTAL_DOCUMENTS: 35,
    TRANSMITTALS: 36,
  }),
});
